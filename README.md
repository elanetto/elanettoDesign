...
**Task:** Collaborate as a group using agile methodology with defined sprints and a Scrum Master to plan, build, and deliver a project from scratch. Our team chose to create an online sticker store.
